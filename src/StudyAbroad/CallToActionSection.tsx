        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-purple-100 text-lg mb-8">
              Join thousands of students who have successfully started their international 
              education journey with our expert guidance and comprehensive support.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-yellow-500 hover:bg-yellow-600 text-gray-800 font-bold py-3 px-8 rounded-lg shadow-lg transition duration-300 transform hover:scale-105 flex items-center justify-center">
                Get Started Now
                <ArrowRight className="w-5 h-5 ml-2" />
              </button>
              <button className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-purple-700 font-bold py-3 px-8 rounded-lg transition duration-300">
          ...
          <div className="text-center">
            <div className="relative inline-block">
              ...
              <div className="bg-white p-8 rounded-xl shadow-xl transform rotate-3 transition-transform duration-300">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">5000+ Students</h3>
                <p className="text-gray-600 mb-4">Successfully placed in top universities worldwide</p>
